...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x1ckoinos/mempool/mempool.proto\x12\x0ekoinos.mempool\x1a\x1ekoinos/protocol/protocol.proto\"#\n\x10mempool_metadata\x12\x0f\n\x07seq_num\x18\x01 \x01(\x04\"=\n\x17\x61\x64\x64ress_resource_record\x12\x0e\n\x06max_rc\x18\x01 \x01(\x04\x12\x12\n\ncurrent_rc\x18\x02 \x01(\x04\"\xab\x02\n\x13pending_transaction\x12\x31\n\x0btransaction\x18\x01 \x01(\x0b\x32\x1c.koinos.protocol.transaction\x12\x1d\n\x11\x64isk_storage_used\x18\x02 \x01(\x04\x42\x02\x30\x01\x12\"\n\x16network_bandwidth_used\x18\x03 \x01(\x04\x42\x02\x30\x01\x12\"\n\x16\x63ompute_bandwidth_used\x18\x04 \x01(\x04\x42\x02\x30\x01\x12$\n\x18system_disk_storage_used\x18\x05 \x01(\x04\x42\x02\x30\x01\x12)\n\x1dsystem_network_bandwidth_used\x18\x06 \x01(\x04\x42\x02\x30\x01\x12)\n\x1dsystem_compute_bandwidth_used\x18\x07 \x01(\x04\x42\x02\x30\x01\"q\n\x1apending_transaction_record\x12@\n\x13pending_transaction\x18\x01 \x01(\x0b\x32#.koinos.mempool.pending_transaction\x12\x11\n\ttimestamp\x18\x02 \x01(\x04\x42\x39Z7github.com/koinos/koinos-proto-golang/v2/koinos/mempoolb\x06proto3'
  ,
...
_PENDING_TRANSACTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'0\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='system_disk_storage_used', full_name='koinos.mempool.pending_transaction.system_disk_storage_used', index=4,
      ...
      serialized_options=b'0\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='system_network_bandwidth_used', full_name='koinos.mempool.pending_transaction.system_network_bandwidth_used', index=5,
      ...
      serialized_options=b'0\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='system_compute_bandwidth_used', full_name='koinos.mempool.pending_transaction.system_compute_bandwidth_used', index=6,
...
_PENDING_TRANSACTION_RECORD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pending_transaction', full_name='koinos.mempool.pending_transaction_record.pending_transaction', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PENDING_TRANSACTION_RECORD.fields_by_name['pending_transaction'].message_type = _PENDING_TRANSACTION
...
_PENDING_TRANSACTION.fields_by_name['system_disk_storage_used']._options = None
_PENDING_TRANSACTION.fields_by_name['system_network_bandwidth_used']._options = None
_PENDING_TRANSACTION.fields_by_name['system_compute_bandwidth_used']._options = None
