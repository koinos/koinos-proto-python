...
_CHAIN_ERROR_DETAILS = _descriptor.Descriptor(
  name='chain_error_details',
  full_name='koinos.chain.chain_error_details',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='koinos.chain.chain_error_details.code', index=0,
...
DESCRIPTOR.message_types_by_name['chain_error_details'] = _CHAIN_ERROR_DETAILS
DESCRIPTOR.enum_types_by_name['error_code'] = _ERROR_CODE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

chain_error_details = _reflection.GeneratedProtocolMessageType('chain_error_details', (_message.Message,), {
  'DESCRIPTOR' : _CHAIN_ERROR_DETAILS,
  '__module__' : 'koinos.chain.error_pb2'
  # @@protoc_insertion_point(class_scope:koinos.chain.chain_error_details)
  })
_sym_db.RegisterMessage(chain_error_details)
