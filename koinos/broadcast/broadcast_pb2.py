...
_MEMPOOL_ACCEPTED = _descriptor.Descriptor(
  name='mempool_accepted',
  full_name='koinos.broadcast.mempool_accepted',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='transaction', full_name='koinos.broadcast.mempool_accepted.transaction', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='receipt', full_name='koinos.broadcast.mempool_accepted.receipt', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='height', full_name='koinos.broadcast.mempool_accepted.height', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'0\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pending_rc_used', full_name='koinos.broadcast.mempool_accepted.pending_rc_used', index=3,
      ...
      serialized_options=b'0\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rc_limit', full_name='koinos.broadcast.mempool_accepted.rc_limit', index=4,
...
_MEMPOOL_ACCEPTED.fields_by_name['transaction'].message_type = koinos_dot_protocol_dot_protocol__pb2._TRANSACTION
_MEMPOOL_ACCEPTED.fields_by_name['receipt'].message_type = koinos_dot_protocol_dot_protocol__pb2._TRANSACTION_RECEIPT
...
DESCRIPTOR.message_types_by_name['mempool_accepted'] = _MEMPOOL_ACCEPTED
...
mempool_accepted = _reflection.GeneratedProtocolMessageType('mempool_accepted', (_message.Message,), {
  'DESCRIPTOR' : _MEMPOOL_ACCEPTED,
  '__module__' : 'koinos.broadcast.broadcast_pb2'
  # @@protoc_insertion_point(class_scope:koinos.broadcast.mempool_accepted)
  })
_sym_db.RegisterMessage(mempool_accepted)
...
_MEMPOOL_ACCEPTED.fields_by_name['height']._options = None
_MEMPOOL_ACCEPTED.fields_by_name['pending_rc_used']._options = None
_MEMPOOL_ACCEPTED.fields_by_name['rc_limit']._options = None
