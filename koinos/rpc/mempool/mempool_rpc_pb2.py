...
_CHECK_TRANSACTION_ELIGIBILITY_REQUEST = _descriptor.Descriptor(
  ...
  full_name='koinos.rpc.mempool.check_transaction_eligibility_request',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='payer', full_name='koinos.rpc.mempool.check_transaction_eligibility_request.payer', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\200\265\030\006', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='payee', full_name='koinos.rpc.mempool.check_transaction_eligibility_request.payee', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\200\265\030\006', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='nonce', full_name='koinos.rpc.mempool.check_transaction_eligibility_request.nonce', index=2,
      number=3, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_payer_rc', full_name='koinos.rpc.mempool.check_transaction_eligibility_request.max_payer_rc', index=3,
      number=4, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'0\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rc_limit', full_name='koinos.rpc.mempool.check_transaction_eligibility_request.rc_limit', index=4,
      ...
      serialized_options=b'0\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='block_id', full_name='koinos.rpc.mempool.check_transaction_eligibility_request.block_id', index=5,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_block_id', full_name='koinos.rpc.mempool.check_transaction_eligibility_request._block_id',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_CHECK_TRANSACTION_ELIGIBILITY_RESPONSE = _descriptor.Descriptor(
  ...
  full_name='koinos.rpc.mempool.check_transaction_eligibility_response',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='koinos.rpc.mempool.check_transaction_eligibility_response.success', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MEMPOOL_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='check_transaction_eligibility', full_name='koinos.rpc.mempool.mempool_request.check_transaction_eligibility', index=4,
...
_MEMPOOL_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='check_transaction_eligibility', full_name='koinos.rpc.mempool.mempool_response.check_transaction_eligibility', index=5,
...
check_transaction_eligibility_request = _reflection.GeneratedProtocolMessageType('check_transaction_eligibility_request', (_message.Message,), {
  ...
  '__module__' : 'koinos.rpc.mempool.mempool_rpc_pb2'
  # @@protoc_insertion_point(class_scope:koinos.rpc.mempool.check_transaction_eligibility_request)
  })
...
check_transaction_eligibility_response = _reflection.GeneratedProtocolMessageType('check_transaction_eligibility_response', (_message.Message,), {
  ...
  '__module__' : 'koinos.rpc.mempool.mempool_rpc_pb2'
  # @@protoc_insertion_point(class_scope:koinos.rpc.mempool.check_transaction_eligibility_response)
  })
